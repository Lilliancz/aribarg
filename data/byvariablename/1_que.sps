* This file may be used to read the data in 'C:\Users\lillianc\Desktop\livechat\aribarg\data\byvariablename\1_que.txt'.
...
* C:\Users\lillianc\Desktop\livechat\aribarg\data\byquestionnaire\1_que.sps.
*. 
...
data list file 'C:\Users\lillianc\Desktop\livechat\aribarg\data\byvariablename\1_que.txt' free
   /Subject (A25)       Cond (A25)          Exper (A50)         Inifile (A25)
    Date (A25)          Time (A25)
    control1 (A50)      post (A50)          pre (A50)           savedchat (A50) 
    wait (A50) 
    tcontrol1 *         tpost *             tpre * .
